	...
	grunt.initConfig(
		{
			...
			checktextdomain: {
				options: {
					text_domain: [ 'ticket-booking' ], // Specify allowed domain(s)
			...
			makepot: {
				target: {
					options: {
						...
						potFilename: 'ticket-booking.pot', // Name of the POT file.
						potHeaders: { // Headers to add to the generated POT file.
							poedit: true, // Includes common Poedit headers.
							'Last-Translator': 'Vishakha Gupta',
							'Language-Team': 'Vishakha Gupta',
